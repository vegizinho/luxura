	...
	<div class="row">
		...
		<div class="col-md-8">
			...
			<p>Tanning is a popular ‘profit centre' in many companies, either as
				the core business or as an extra service. The attractive range of
				Luxura sunbeds therefore offers solutions for all these different
				entrepreneurs and their varying requirements - from basic models for
				smaller spaces to those offering absolute luxury. There are
				horizontal or vertical models, a wide range of optional features and
				fabulous colour variants. It's perfectly clear: if you want a
				profitable sun to shine on your company, you're in the right place
				with Luxura!
			</p>
			<hr>
